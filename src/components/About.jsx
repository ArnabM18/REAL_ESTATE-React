...
const About=() => {
 return(
   ...
   <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
     <div className="grid grid-cols-2 gap-6 md:gap-10 w-full 2xl 2xl:pr-28">
        <div>
     ...
     <p className="my-10 max-w-lg" >Lorem ipsum dolor sit amet consectetur adipisicing elit.
         Soluta fuga itaque quaerat, magnam nostrum quisquam assumenda,
          quibusdam est ex et minima perferendis aliquid consequatur quam 
          sed sint facilis, ipsam consectetur.</p>
